        ...
        <form action="{{ route('mentor.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-card">
                ...
                <div class="form-card-header">
                    ...
                    <div>
                        <div class="form-card-title">Become a Mentor</div>
                        <div class="form-card-sub">Share your experience with developers</div>
                    </div>
                </div>
                ...
                <div class="form-card-body layout-container">
                    ...
                    <div class="left-column">
                        ...
                        <div class="avatar-upload-wrapper">
                            ...
                            <div class="avatar-preview-box" onclick="document.getElementById('profile_picture').click()">
                                ...
                                <span id="avatarPlaceholder" class="avatar-placeholder">
                                    <i class="fa-solid fa-camera"></i><br>Upload Photo
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="form-label">
                                <i class="fa-solid fa-address-card"></i> Bio
                            </label>
                            <textarea name="bio" class="form-textarea" placeholder="Tell us about yourself and your expertise...">{{ old('bio') }}</textarea>
                        </div>
                    ...
                    <div class="right-column">
                        ...
                        <div class="form-group-row">
                            <div class="form-group">
                                <label class="form-label">
                                    <i class="fa-solid fa-briefcase"></i> Years of Experience *
                                </label>
                                <input type="number" id="experience_years" name="experience_years" class="form-input" min="0" max="50" placeholder="Years" required value="{{ old('experience_years') }}">
                                <small id="experience-display" style="color:#666;"></small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="organization" class="form-input" placeholder="Company / Organization" value="{{ old('organization') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group-row">
                            <div class="form-group">
                                <label class="form-label">
                                    <i class="fa-brands fa-linkedin"></i> LinkedIn URL
                                </label>
                                <input type="url" name="linkedin_url" class="form-input" placeholder="https://linkedin.com/in/..." value="{{ old('linkedin_url') }}">
                            </div>

                            <div class="form-group">
                                <label class="form-label">
                                    <i class="fa-solid fa-graduation-cap"></i> Specialization *
                                </label>
                ...
                <div class="form-footer">
                    <div class="form-footer-note">
                        <i class="fa-solid fa-circle-check"></i> Your information is secure and protected
                    </div>
                    <button type="submit" class="btn btn-primary">
                        <i class="fa-solid fa-user-plus"></i> Register as Mentor
                    </button>
                </div>
