          ...
          <div class="card-header">
            <div class="card-header-left">
              ...
              <div>
                ...
                <div class="card-sub">Upload cover images for your project</div>
              </div>
            </div>
          </div>
          <div class="card-body">
            <div class="form-group" style="margin-bottom:0;">
              ...
              />
              <p class="form-hint">Accepted formats: JPG, PNG, GIF, SVG — max 2MB per image</p>
...
<script>
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // SPECIALIZATIONS — Tom Select (تم التعديل والربط الذكي)
  // ─────────────────────────────────────────────────────────────────────────
...
tomSelectControl.on('change', function(values) {
  ...
  // تعديل الرابط هنا باستخدام الـ Named Route الخاص بلارافيل لمنع تداخل الروابط (MethodNotAllowed)
