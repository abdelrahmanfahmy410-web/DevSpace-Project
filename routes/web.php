...
use App\Http\Controllers\{
    DeveloperController, InvestorController, RoleController, MentorController,
    SkillController, SpecializationController, DeveloperSkillController,
    ProjectController, AreaOfInterestController, UserController,
    DashboardController, ConversationController, TeamRoleController,
    FollowingController, HomeController
};
...
Route::get('/team-member/{teamRole}/profile', [ProjectController::class, 'memberProfile'])->name('team-role.profile');
